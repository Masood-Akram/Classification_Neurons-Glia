...
Methods and Software, 24 (2009), 669-685.
...
PSwarm with bound and linear constraints:
 ...
 - A .Net (Microsoft Windows) interface to Visual Basic (VB).
...
Unzip  the  PPSwarm_v1_5_2.zip  file  in  any  location  using your
favorite   unzip  software.  A  directory  PPSwarm_v1_5_2  will  be
created,   having   as   subdirectories  'nl',  'include',  'libs',
'DotNetVB',  which  refers  to the AMPL problems models (in the .nl
format),  the corresponding interface include files, directories to
place  additional  includes  and libs (AMPL, BLAS or LAPACK), and a
Visual Basic project to use PSwarm, respectively.
...
Type  'make serial_linear' for the corresponding version with linear
constraints.
...
Type  'make parallel_linear'  for  the  corresponding  version  with
linear constraints.

Type 'make ampl' to make the ampl version of pswarm.

Type  'make  ampl_linear'  for the corresponding version with linear
constraints.
...
Type  'nmake  -f makefile.vc serial_linear'  for  the corresponding
version with linear constraints.

Type 'nmake -f makefile.vc ampl' for the AMPL version.

Type   'nmake  -f makefile.vc ampl_linear'  for  the  corresponding
version with linear constraints.
...
Type   'nmake  -f makefile.vc r_linear'   for   the   corresponding
version with linear constraints.

Type 'nmake -f makefile.vc py' for the Python dynamic library.

Type   'nmake  -f makefile.vc py_linear'   for   the  corresponding
version with linear constraints.

Type 'nmake -f makefile.vc lib' for the pswarm library.

Type   'nmake  -f makefile.vc lib_linear'   for  the  corresponding
version with linear constraints.

Type  'nmake -f makefile.vc dll' for the pswarm dll library used in
the Visual Basic .net project

Type   'nmake  -f makefile.vc dll_linear'   for  the  corresponding
version with linear constraints.
...
4. Contents of the PPSwarm_v1_5_2 directory
----------------------------------------

In the directory PPSwarm_v1_5_2 there are the following files:
...
pswarmDLL.c - VB interface to PSwarm.
...
DotNetVB  -  A  Visual  Basic  Microsoft project. Uses the pswarm to
solver the hs024 problem coded in Visual Basic.
